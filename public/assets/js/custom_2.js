(function($) {
  ...
  $('.simpleTab .navlink').click(function(){
		var target_elem = $(this).data('target');
		$(this).closest('.tab-pane').find('.tabpane').hide();
		/* $('.tabContent > .tabpane').hide(); */
		$('.tabContent > .tabpane.'+target_elem).show();
	});
...
$(document).ready(function (){
	...
	$('.search .form-group .clearsearch').click(function(){
		table.search($(this).val('')).draw();
		$('input[type="search"]').val('');
		$(this).removeClass('active');
	});
	
	$('.search .form-group .form-control.search-icon').keyup(function(){
		if($(this).val()!=""){
