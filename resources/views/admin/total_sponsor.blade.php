          ...
          <div class="content-wrapper">
						<nav>
							<ol class="breadcrumb h4">
								...
								<li class="breadcrumb-item"><a href="">Total Sponsors</a></li>
							</ol>
						</nav>
						...
						<table class="table table-striped table-borderless text-black mb-0 dataTable">
							<thead>
								...
								<tbody>
									<?php $i = 1;?>
									@foreach($total_sponsors as $k=>$user)
										<tr>
											<td>{{$i}}</td>
                        ...
                        <div class="action">
                        	<span class="border border-info text-info rounded-pill btn-8" id='user_type'>Sponsor</span>
                        </div>
                      </td>
                      <td>
