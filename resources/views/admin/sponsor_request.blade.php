          ...
          <div class="content-wrapper">
						<nav>
							<ol class="breadcrumb h4">
								...
								<li class="breadcrumb-item"><a href="">Sponsor Account Requests</a></li>
							</ol>
						</nav>
						...
						<table class="table table-striped table-borderless text-black mb-0" id="myTable">
							<tbody>
								@foreach($sponsors as $row => $sponsor)
									<tr>
										<td>
											<div class="avatar md">
												<div class="inner">
										...
										<td class="pl-1">
											<div class="font-16 weight-600 mb-2"><a href="{{route('userDetails',['id'=> $sponsor['id']])}}">{{$sponsor['name']}}</a></div>
											<small>Specialization</small>
										</td>
										<td class="pl-1 pt-4">
											<div class="mb-2">Email</div>
											<div class="font-16 weight-600 mb-2">{{$sponsor['email']}}</div>
										</td>
										<td class="w-100 pt-4 pl-1">
											<div class="mb-2">Date</div>
											<div class="font-16 weight-600 mb-2"><?php echo date("d-m-Y", strtotime($sponsor['created_at']));?></div>
										</td>
										<?php 
												...
												<div class="modal-dialog modal-sm modal-dialog-centered">
													<div class="modal-content">
														<div class="modal-body">
															...
															<form method="post" action="{{route('change_user_status')}}" id="statusChangeForm">
															@csrf
															<input type="hidden" name="user_id2" id="user_id2" value="">
