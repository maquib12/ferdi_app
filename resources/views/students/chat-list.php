		...
		<section class="py-5">
			<div class="container">
				<div class="heading border-bottom border-xlight border-solid-2 mb-4 pb-4 d-flex align-items-center">
					<h1 class="col-sm-3 p-0 font-bold font-36">Facilitator</h1>
				</div>
				<div class="overflow-hidden rounded-md">
					<div class="table-responsive">
						<table class="table table-bordered text-dark mb-0">
							<thead class="bg-dar bg-dark text-white">
								<tr>
									<th width="50" class="border-0 border-right"></th>
									<th width="150" class="border-0 py-3">Student Name</th>
									<th width="200" class="border-0 py-3">Course Name</th>
									<th class="border-0 py-3">Message</th>
									<th width="160" class="border-0 py-3">Date/Time</th>
									<th width="50" class="border-0 py-3"></th>
								</tr>
							</thead>
							<tbody class="bg-white font-14">
								<tr>
									<td class="unread align-middle">
										<div class="d-flex align-items-center">
											<div class="bg-primary text-white rounded-pill name-initial sm">JB</div>
											<div class="bg-primary text-white rounded-pill name-initial sm ml-n2">JC</div>
										</div>
									</td>
									<td class="align-middle">Omotayo</td>
									<td class="align-middle">Lorem Ipsum</td>
									<td>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the...</td>
									<td>02:05 22/07/2021</td>
									<td  class="border-right-0"><a href="chat.php"><img src="assets/img/icons/chat.svg"></a></td>
								</tr>
								<tr>
									<td class="unread align-middle">
										<div class="d-flex align-items-center">
