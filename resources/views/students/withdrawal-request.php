				...
				<form>
					...
					<div class="row">
						<div class="col-sm-12 mb-4 pb-2">
							<select class="selectpicker bg-dark icon-dropdown" data-width="100%">
							  <option data-icon="icon-hdfc">HDFC</option>
							  <option data-icon="icon-sbi">SBI</option>
							  <option data-icon="icon-boi">BOI</option>
							  <option data-icon="icon-axis">AXIS</option>
							</select>
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">Account Number<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="Account Number">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">Confirm Account number<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="Confirm Account Number">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">IFSC CODE<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="IFSC CODE">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">Account Holder Name<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="Account Holder Name">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">Phone Number<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="Phone Number">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-2">
							<label class="pb-1 font-xlight">Nick Name<span class="text-primary">*</span></label>
							<input class="form-control bg-transparent border-light p-4 font-14 rounded-sm text-white" placeholder="Nick Name">
						</div>
					</div>
					<div class="border-bottom border-xlight border-solid-2 my-5"></div>
					<div class="col-sm-6 mx-auto pt-4">
						<button class="btn btn-primary btn-block py-3 rounded-pill">Confirm</button>
					</div>
				</form>
			</div>
		</section>
