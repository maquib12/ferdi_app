		...
		<section class="py-5">
			<div class="container">
				<div class="heading border-bottom border-xlight border-solid-2 mb-4 pb-1 d-flex align-items-center">
					...
					<div class="action">
						<a href="" class="ml-3"><img src="assets/img/icons/edit-circle-w.svg"></a>
						<a href="" class="ml-3"><img src="assets/img/icons/plus-circle.svg"></a>
					</div>
				</div>
				<div class="row pt-2">
					<div class="col-sm-4">
						<div class="bg-dark px-4 py-4 rounded-md">
							<div class="px-2">
								...
								<p class="font-semibold mt-2">The Business Intelligence Analyst Course 2021</p>
								<p>Module 1</p>
								<div class="border-bottom border-primary border-solid-2 mt-4"></div>
								<div class="check-list mt-3">
									<ul class="list-group list-group-flush">
										<li class="list-group-item active">Question 1 <i></i></li>
										<li class="list-group-item">Question 2 <i></i></li>
										<li class="list-group-item">Question 3 <i></i></li>
										<li class="list-group-item">Question 4 <i></i></li>
										<li class="list-group-item">Question 5 <i></i></li>
										<li class="list-group-item">Question 6 <i></i></li>
										<li class="list-group-item">Question 7 <i></i></li>
										<li class="list-group-item">Question 8 <i></i></li>
										<li class="list-group-item">Question 9 <i></i></li>
										<li class="list-group-item">Question 10 <i></i></li>
									</ul>
								</div>
							</div>
						</div>
					...
					<div class="col-sm-8">
						<form>
							<div class="d-flex align-items-center mb-4 pb-1">
								<h4 class="my-0 flex-fill">Question 1 / 10</h4>
								<button class="btn btn-primary rounded-pill px-5"><span class="d-block my-1">Submit</span></button>
							</div>
							<textarea class="form-control border-0 lh-32 bg-dark px-4 py-2 rounded-sm resize-none text-white font-xlight shadow-none" rows="3">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd</textarea>
							<div class="row mt-3">
								<div class="col-sm-6 my-2 py-1">
									<label class="lg-opt d-block">
										<input type="radio" name="ques-1" value="a" class="edit-opt">
										<div class="d-flex align-items-center bg-dark p-4 rounded-md">
											<div class="opt mr-1">A</div>
											<input type="text" class="text form-control border-0 bg-transparent text-white shadow-none" value="Lorem Ipsum dolor sit amet">
										</div>
									</label>
								</div>
								<div class="col-sm-6 my-2 py-1">
									<label class="lg-opt d-block">
										<input type="radio" name="ques-1" value="b" class="edit-opt">
										<div class="d-flex align-items-center bg-dark p-4 rounded-md">
								...
								<div class="col-sm-6 my-2 py-1">
									<label class="lg-opt d-block">
										<input type="radio" name="ques-1" value="c" class="edit-opt">
										<div class="d-flex align-items-center bg-dark p-4 rounded-md">
								...
								<div class="col-sm-6 my-2 py-1">
									<label class="lg-opt d-block">
										<input type="radio" name="ques-1" value="d" class="edit-opt">
										<div class="d-flex align-items-center bg-dark p-4 rounded-md">
					...
					<div class="col-sm-6 my-3">
						<div class="card bg-dark p-0 rounded-md d-flex flex-md-row">
							<div class="thumbnail-md rounded-left-md">
								<img src="assets/img/img-1.png" class="img">
							</div>
							<div class="info flex-fill pl-3 pr-3 py-0 d-flex flex-column justify-content-between">
								<div class="d-flex align-items-center mt-3">
									<h4 class="text-white flex-fill text-truncate mb-2">Doriyo Schultz</h4>
									<div class="ellipsis-dropdown">
										<span role="button" class="pt-0 px-2 text-xlight my-0" data-toggle="dropdown">
											<img src="assets/img/icons/v-ellipsis.svg">
										</span>
										<div class="dropdown-menu dropdown-menu-right gray-icon mr-2 py-1">
											<a href="" class="dropdown-item px-3 border-bottom" type="button"><i class="icon"><img src="assets/img/icons/block.svg"></i> Block</a>
											<a href="" class="dropdown-item px-3" type="button"><i class="icon"><img src="assets/img/icons/report.svg"></i> Report</a>
										</div>
									</div>
								</div>
								<div class="text-xlight font-xlight mt-0 mb-2">04 March 2021</div>
								<p class="text-xlight font-light">Location : Country in North America</p>
							</div>
						</div>
					</div>
					<div class="col-sm-6 my-3">
