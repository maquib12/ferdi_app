		...
		<section class="py-5">
			<div class="container">
				<div class="heading border-bottom border-xlight border-solid-2 mb-5 pb-1">
					<h1 class="pb-2 font-bold font-36">Site Map</h1>
				</div>
				<div class="content">
					<div class="row">
						<div class="col-sm-4">
							...
							<h4 class="font-semibold pb-2">Resources</h4>
							<ul class="list text-xlight font-xlight underline font-18 mb-5 pb-md-4">
								<li><a href="">FAQ</a></li>
						...
						<div class="col-sm-4">
							<h4 class="font-semibold pb-2">CLASS CATEGORIES</h4>
							<ul class="list text-xlight font-xlight underline font-18 mb-5 pb-md-4">
								<li><a href="">Courses by Subject</a></li>
								<li><a href="">Arts & Entertainment</a></li>
								<li><a href="">Home & Lifestyle</a></li>
								<li><a href="">Online Master's Degrees</a></li>
								<li><a href="">Business</a></li>
							</ul>
							<h4 class="font-semibold pb-2">Social</h4>
							<ul class="list text-xlight font-xlight underline font-18 mb-5 pb-md-4">
								<li><a href="">Ferdi Facebook</a></li>
								<li><a href="">Ferdi Twitter</a></li>
								<li><a href="">Ferdi LinkedIn</a></li>
								<li><a href="">Ferdi Instagram</a></li>
							</ul>
						</div>
						<div class="col-sm-4">
							<h4 class="font-semibold pb-2">Courses by Subject</h4>
							<ul class="list text-xlight font-xlight underline font-18 mb-5 pb-md-4">
								<li><a href="">Architecture</a></li>
								<li><a href="">Art & Culture</a></li>
								<li><a href="">Biology & Life Sciences</a></li>
								<li><a href="">Business & Management</a></li>
								<li><a href="">Education & Teacher Training</a></li>
							</ul>
							<h4 class="font-semibold pb-2">ARTICLES</h4>
							<ul class="list text-xlight font-xlight underline font-18 mb-5 pb-md-4">
