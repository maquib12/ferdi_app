			...
			<div class="container">
				...
				<div class="msg-wrapper">
					<div class="bg-dark px-4 py-4">
						<h5 class="my-0">Chat</h5>
					</div>
					<div class="msg-chat">
						<div class="msg left-msg">
							<div class="msg-img" style="background-image: url(assets/img/users/4.jpg)"></div>
							<div class="msg-bubble">
								<div class="msg-info">
									<div class="msg-info-name">Olivia</div>
						...
						<div class="msg right-msg">
							<div class="msg-img" style="background-image: url(assets/img/users/5.jpg)"></div>
							<div class="msg-bubble">
								<div class="msg-info">
									<div class="msg-info-name">Emma</div>
						...
						<div class="msg left-msg">
							...
							<div class="msg-bubble">
								<div class="msg-info">
									<div class="msg-info-name">Olivia</div>
									<div class="msg-info-time">12:32</div>
								</div>
								<div class="msg-text">
									Why do we use it?
								</div>
						...
						<div class="msg right-msg">
							...
							<div class="msg-bubble">
								<div class="msg-info">
									<div class="msg-info-name">Emma</div>
									<div class="msg-info-time">12:33</div>
								</div>
								<div class="msg-text">
					...
					<form class="bg-dark d-flex align-items-center border-top">
						<input type="text" class="form-control rounded-0 border-0 size-16 p-3 h-auto" placeholder="Enter your message...">
						<button type="submit" class="bg-transparent border-0 ml-4 mx-2"><img src="assets/img/icons/send.svg"></button>
						<span class="bg-transparent border-0 mr-3 attach-button"><input type="file"><img src="assets/img/icons/attach.svg" width="25"></span>
					</form>
				</div>
			</div>
		</section>
