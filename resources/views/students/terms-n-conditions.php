		...
		<section class="py-5">
			<div class="container">
				<div class="heading border-bottom border-xlight border-solid-2 mb-5 pb-1">
					<h1 class="pb-2 font-bold font-36">Terms &amp; Conditions</h1>
				</div>
				<div class="content">
					<h2 class="font-bold">Lorem ipsum dolor sit amet,<br> Consetetur Sadipscing Elitr</h2>
					<div class="my-4">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.</div>
					<div class="bg-dark px-4 py-5 my-5">
						<div class="font-medium font-18">01. Welcome to Ferdi!</div>
						<ul class="check-list font-xlight">
							<li>Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin</li>
							<li>Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin</li>
							<li>Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin</li>
							<li>Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin</li>
							<li>Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin</li>
					...
					<h4 class="font-medium my-4">Lorem ipsum dolor sit amet, Consetetur Sadipscing Elitr</h4>
					<p>Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua. At vero eos et accusam et justo duo dolores et ea rebum. Stet clita kasd gubergren, no sea takimata sanctus est Lorem ipsum dolor sit amet. Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt ut labore et dolore magna aliquyam erat, sed diam voluptua.<br><br>
