		...
		<section class="banner py-5">
			<div class="container">
				<div class="card bg-blue p-4 rounded-md my-3">
					<div class="row">
						<div class="thumbnail-lg rounded-md overflow-hidden mx-3">
							<div class="inner">
						...
						<div class="col-sm-9 d-flex flex-column">
							<div class="flex-fill">
								<h1 class="text-uppercase"><b>Howard</b> <span class="font-xlight">Schultz</span></h1>
								<div class="font-xlight font-18">Teaches Sales and Persuasion</div>
								<div class="d-inline-flex align-items-center border-bottom border-white border-solid-2 mt-3">
							...
							<div>
								<a href="" class="d-inline-flex align-items-center text-primary border-bottom border-primary pb-2 text-decoration-none">
									<img src="assets/img/icons/line-edit.svg" class="mr-4"> Create A New Course
								</a>
							</div>
						</div>
					</div>
				...
				<div class="row">
						...
						<div class="card bg-blue p-4 rounded-md">
							<div class="d-flex align-items-center mb-4">
								<div class="icon-md bg-primary mr-4">
									<img src="assets/img/icons/total-earnings.svg">
								</div>
								<h4 class="flex-fill text-uppercase font-regular text-underline-light my-0">Total Earnings</h4>
								<h3 class="font-bold text-white">₦1000</h3>
							</div>
					...
					<div class="col-sm-6 my-3">
						<div class="card bg-blue p-4 rounded-md">
							<div class="d-flex align-items-center mb-4">
								<div class="icon-md bg-primary mr-4">
									<img src="assets/img/icons/active-courses.svg">
								</div>
								<h4 class="flex-fill text-uppercase font-regular text-underline-light my-0">Active Courses</h4>
								<h3 class="font-bold text-white">400</h3>
							</div>
							<p class="font-xlight mb-1">Progress</p>
							<div class="progress light">
					...
					<div class="col-sm-6 my-3">
						<div class="card bg-blue p-4 rounded-md">
							<div class="d-flex align-items-center mb-4">
								...
								<h4 class="flex-fill text-uppercase font-regular text-underline-light my-0">Fan Followings</h4>
								<h3 class="font-bold text-white">5000</h3>
							</div>
							<p class="font-xlight mb-1">Progress</p>
							<div class="progress light">
					...
					<div class="col-sm-6 my-3">
						<div class="card bg-blue p-4 rounded-md">
							<div class="d-flex align-items-center mb-4">
								<div class="icon-md bg-primary mr-4">
									<img src="assets/img/icons/subscribed.svg">
								</div>
								<h4 class="flex-fill text-uppercase font-regular text-underline-light my-0">Subscribed</h4>
								<h3 class="font-bold text-white">4100</h3>
							</div>
							<p class="font-xlight mb-1">Progress</p>
							<div class="progress light">
