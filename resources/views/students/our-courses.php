			...
			<div class="container mt-4">
				<div class="row align-items-center pb-5 pb-2">
					...
					<div class="col-sm-6 ml-auto">
						<div class="banner-video">
							<img src="assets/img/icons/circle.svg" data-parallax='{"x": -100, "y": 350}' height="60" style="top: -35px; left: -25px; z-index: 1">
							<img src="assets/img/icons/circle.svg" data-parallax='{"x": 0, "y": 150}' height="40" style="top: 20px; left: 40px; z-index: 1">
							<img src="assets/img/icons/dots-lg.svg" data-parallax='{"x": -250, "y": 0}' style="top: 248px; right: -10px">
							<div class="rounded-lg overflow-hidden position-relative">
								<img class="card-img-top img-fluid" src="assets/img/our-courses.jpg" />
							</div>
						</div>
					</div>
				</div>
				<div class="search-bar full mt-5">
					<form class="d-flex align-items-center">
						<input class="form-control bg-transparent col-sm-3 px-0 search" placeholder="Search Your Course">
		...
		<section class="my-5 pb-4">
			<div class="container py-5 my-5">
				<div class="row align-items-center">
					<div class="col-sm-6">
						<h4 class="my-0">All Courses (986 Courses)</h4>
					</div>
