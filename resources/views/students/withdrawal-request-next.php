				...
				<form>
					...
					<div class="row pb-4">
						<div class="col-sm-6 mx-auto mb-4 pb-2">
							<input class="form-control border-bottom bg-transparent border-top-0 border-right-0 border-left-0 border-bottom rounded-0 border-light shadow-none text-white text-center font-36 font-bold" value="$20,201">
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-11 mx-auto">
							<label class="radio-lg my-4 d-block" role="button">
								<input type="radio" name="bank" class="d-none" checked>
								<div class="d-flex px-4 border border-light rounded-md radio-inner">
									<div class="d-flex align-items-center border-right border-light py-3 text-nowrap">
										<div class="icon mr-4"><img src="assets/img/bank/hdfc.png"></div>
										<div class="text-uppercase h6 my-0 pl-2 pr-5">
											<div class="font-xlight mb-1">HDFC Bank</div>
											<div>Jason Bark</div>
										</div>
									</div>
									<div class="h4 mb-0 pl-5 flex-fill col d-flex align-items-center">************7881</div>
							...
							<label class="radio-lg my-4 d-block" role="button">
								<input type="radio" name="bank" class="d-none">
								<div class="d-flex px-4 border border-light rounded-md radio-inner">
									<div class="d-flex align-items-center border-right border-light py-3 text-nowrap">
										<div class="icon mr-4"><img src="assets/img/bank/sbi.png"></div>
										<div class="text-uppercase h6 my-0 pl-2 pr-5">
											<div class="font-xlight mb-1">SBI Bank</div>
											<div>Jason Bark</div>
										</div>
									</div>
									<div class="h4 mb-0 pl-5 flex-fill col d-flex align-items-center">************9425</div>
									<div class="radio-icon px-2 d-flex align-items-center border-left border-light pl-4">
										<em></em>
									</div>
								</div>
							</label>
							<div class="text-md-right text-center py-3">
								<button class="btn btn-default-outline-light px-5 py-3">Add New Account</button>
							</div>
						</div>
					</div>
					<div class="border-bottom border-xlight border-solid-2 my-5 pt-4"></div>
					<div class="col-sm-6 mx-auto pt-4">
						<button class="btn btn-primary btn-block py-3 rounded-pill">Withdrawal</button>
					</div>
				</form>
			</div>
		</section>
