				...
				<div class="row">
					<div class="col-sm-7 pr-md-5 border-right border-xSolid border-primary">
						<div class="mr-md-3">
							...
							<div class="d-flex bg-dark rounded-sm rounded-sm overflow-hidden">
								<div class="link d-flex align-items-center pl-4 text-xlight">https://www.ferdi.com/invite/nzr2Klj5e6AE</div>
								<button class="btn btn-primary rounded-0 px-4 py-2 text-uppercase font-18 ml-auto"><span class="d-block py-1">Copy To Link</span></button>
							</div>
						</div>
						...
						<div class="d-flex align-items-center pt-2 mr-md-3">
							...
							<div class="d-flex ml-auto">
								<a href="" class="bg-dark p-2 rounded-sm d-flex align-items-center ml-3 icon ease"><img src="assets/img/icons/mail.svg"></a>
								<a href="" class="bg-dark p-2 rounded-sm d-flex align-items-center ml-3 icon ease"><img src="assets/img/icons/messenger.svg"></a>
								<a href="" class="bg-dark p-2 rounded-sm d-flex align-items-center ml-3 icon ease"><img src="assets/img/icons/phone-call.svg"></a>
							</div>
						</div>
					</div>
