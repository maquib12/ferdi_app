		...
		<section class="banner">
			<div class="container">
				<div class="card bg-blue p-4 rounded-md my-3 text-center">
					<div class="text-right mb-4 pb-2"><span role="button"><img src="assets/img/icons/close-w.svg"></span></div>
					<div class="icon d-table mx-auto mb-4 pb-3">
						<img src="assets/img/icons/tick-lg.svg">
					</div>
					<h2 class="text-uppercase font-36 font-bold">Successful</h2>
					<div class="text-xlight font-xlight col-sm-10 mx-auto mt-3 mb-4">Lorem Ipsum Is Simply Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum Is Text Of The Printing IN IPSUM Typesettin Industry Lorem Ipsum</div>
					<div class="font-36 font-xlight pb-4"><span class="font-bold">70%</span> You Scored</div>
					<button class="btn btn-primary btn-block py-2 rounded-pill mt-md-5 mb-4 col-sm-4 mx-auto"><span class="d-block my-1 font-regular text-uppercase">Next Module</span></button>
				</div>
			</div>
		</section>
		<footer class="py-5">
