			...
			<div class="container">
				<form>
					<div class="heading border-bottom border-xlight border-solid-2 mb-4 pb-1">
						<h4 class="pb-2 font-regular">Course Info</h4>
					</div>
					<div class="row">
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Business Category</label>
							<select class="form-control bg-dark border-dark rounded-pill px-4 font-14 text-white border-0">
						...
						<div class="form-group col-sm-6 mb-4 pb-1">
							...
							<input class="form-control bg-dark border-dark rounded-pill p-4 font-14 text-white border-0" placeholder="Course name">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Choose A Multiple Language</label>
							<input class="form-control bg-dark border-dark rounded-pill p-4 font-14 text-white border-0" placeholder="Choose A Multiple Language">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-1">
							...
							<div class="form-control bg-dark border-dark border-0 rounded-pill p-0 d-flex align-items-center">
								...
								<input class="font-16 text-xlight border-0 h-100 bg-transparent flex-fill px-4 font-18" value="10000">
							</div>
						</div>
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Description</label>
							<textarea class="form-control bg-dark border-dark rounded-md p-4 font-14 text-white border-0 resize-none" rows="6"></textarea>
						</div>
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Upload Video & Images</label>
					...
					<div class="row pt-2">
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Module Name</label>
							<input class="form-control bg-dark border-dark rounded-pill p-4 font-14 text-white border-0" placeholder="Choose A Multiple Language">
						</div>
						<div class="form-group col-sm-6 mb-4 pb-1">
							<label class="font-14 pb-1">Price</label>
