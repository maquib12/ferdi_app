		...
		<section class="py-5">
			<div class="container">
				...
				<div class="row mx-0 chat-wrapper overflow-hidden rounded-sm">
					<div class="col-sm-3 bg-dark pt-4">
						<div class="avatar-v position-relative d-table mx-auto">
							<img src="assets/img/users/5.jpg" class="rounded-sm">
							<span class="status mr-n1 mb-n1"></span>
						</div>
						<div class="text-center mt-2">
							<h5 class="mb-1">Jason Bark</h5>
						...
						<div class="d-flex align-items-center mt-4 pb-3 border-bottom border-xlight">
							...
							<div class="countw30 bg-theme-blue text-white ml-auto">4</div>
						</div>
						<div class="list mx-md-n3">
							<div class="item">
								<div class="item-inner">
									<div class="avatar-v md">
										<img src="assets/img/users/1.jpg" class="img-fit rounded-xs">
									</div>
									<div class="font-18 ml-4">Howard Schultz</div>
								</div>
							</div>
							<div class="item active">
								<div class="item-inner">
									<div class="avatar-v md">
										<img src="assets/img/users/2.jpg" class="img-fit rounded-xs">
									</div>
									<div class="font-18 ml-4">John DOE</div>
							...
							<div class="item">
								<div class="item-inner">
									<div class="avatar-v md">
										<img src="assets/img/users/3.jpg" class="img-fit rounded-xs">
									</div>
									<div class="font-18 ml-4">Noah Schultz</div>
								</div>
							</div>
							<div class="item">
								<div class="item-inner">
									<div class="avatar-v md">
										<img src="assets/img/users/4.jpg" class="img-fit rounded-xs">
									</div>
									<div class="font-18 ml-4">Howard Schultz</div>
									<div class="count">3</div>
								</div>
					...
					<div class="col-sm-9 border border-xlight px-3 d-flex flex-column h-100">
						<div class="d-flex align-items-center py-3 border-bottom border-xlight">
							<div class="avatar-v md mr-3">
								<img src="assets/img/users/5.jpg" class="img-fit rounded-xs">
							</div>
							<div class="flex-fill">
								<div class="font-18">John DOE</div>
								<div class="font-12">Active Now</div>
							</div>
							<div>
								<a href="" class="text-white">
									<img src="assets/img/icons/sort.svg">
									Sort By
								</a>
						...
						<div class="chat-box flex-fill overflow-auto my-2 pr-2 slim-scroll">
							<div class="message received">
								<div class="message-inner">
									...
									<div class="message-text">
										<div class="text">Hey Jason Bark</div>
						...
						<div class="chat-footer pb-4 d-flex">
							<div class="bg-dark border-0 rounded-pill d-flex flex-fill">
								<input type="text" class="shadow-none border-0 flex-fill bg-transparent px-4 input text-white" placeholder="Enter your meassage here,">
								<label class="my-0 px-4 ml-3 border-left border-xlight d-flex align-items-center" role="button">
									<img src="assets/img/icons/link.svg"><input type="file" class="d-none">
								</label>
							</div>
							<button class="btn btn-primary rounded-pill px-4 d-flex align-items-center ml-md-3">SEND <img src="assets/img/icons/send-2.svg" class="ml-3"></button>
						</div>
					</div>
				</div>
			</div>
