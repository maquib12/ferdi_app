					...
					<div class="col-sm-7 pr-md-5 border-right border-xSolid border-primary">
						<div class="mr-md-3">
							...
							<div class="d-flex bg-dark rounded-sm rounded-sm overflow-hidden">
								<div class="link d-flex align-items-center pl-4 text-xlight">
									<input type="hidden" id="share_url" class="border-0 bg-transparent w-100" value="https://quytech.net/ferdi_app/public/refer?ref={{$referalCode->referal_code}}" class="url_link" readonly>https://quytech.net/ferdi_app/public/refer?ref={{$referalCode->referal_code}}</div>
								<button class="btn btn-primary rounded-0 px-4 py-2 text-uppercase font-18 ml-auto cToCb"><span class="d-block py-1">Copy To Link</span></button>
							</div>
						</div>
