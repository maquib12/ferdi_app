			...
			<div class="container">
				...
				<div class="row">
					<div class="col-sm-3 text-white">
						<div class="d-md-table text-center mt-md-2">
							<div class="font-80 font-bold">4.5</div>
						...
						<div class="row align-items-center">
							<div class="col-sm-9">
								<div class="progress rounded-lg bg-white">
									<div class="progress-bar" style="width: 85%" aria-valuenow="100" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
							</div>
							<div class="col-sm-3 px-0 d-flex align-items-center justify-content-between pl-2 pr-3 px-md-0 my-2 my-md-0">
								...
								<h4 class="text-primary my-0">85%</h4>
							</div>
						</div>
						<div class="row align-items-center">
							<div class="col-sm-9">
							...
							<div class="col-sm-3 px-0 d-flex align-items-center justify-content-between pl-2 pr-3 px-md-0 my-2 my-md-0">
								...
								<h4 class="text-primary my-0">65%</h4>
							</div>
						</div>
						<div class="row align-items-center">
							<div class="col-sm-9">
							...
							<div class="col-sm-3 px-0 d-flex align-items-center justify-content-between pl-2 pr-3 px-md-0 my-2 my-md-0">
								...
								<h4 class="text-primary my-0">50%</h4>
							</div>
						</div>
						<div class="row align-items-center">
							<div class="col-sm-9">
							...
							<div class="col-sm-3 px-0 d-flex align-items-center justify-content-between pl-2 pr-3 px-md-0 my-2 my-md-0">
								...
								<h4 class="text-primary my-0">30%</h4>
							</div>
						</div>
						<div class="row align-items-center">
							<div class="col-sm-9">
								<div class="progress rounded-lg bg-white">
									<div class="progress-bar" style="width: 15%" aria-valuenow="15" aria-valuemin="0" aria-valuemax="100"></div>
								</div>
							</div>
							<div class="col-sm-3 px-0 d-flex align-items-center justify-content-between pl-2 pr-3 px-md-0 my-2 my-md-0">
								<div class="text-orange mx-2 text-nowrap">
								...
								<h4 class="text-primary my-0">15%</h4>
							</div>
						</div>
					</div>
				</div>
					...
					<div class="col-sm-9">
						<div class="search-bar">
							<form class="d-flex align-items-center">
								<input class="form-control bg-transparent search" placeholder="Search Review">
								<button class="btn btn-primary rounded-pill search px-4 py-md-2 mr-1"><span class="mx-md-4 px-md-2 py-md-1 d-block">Search</span></button>
							</form>
						</div>
					</div>
					<div class="col-sm-3">
				...
				<div class="row mt-5 ml-md-0 px-3 px-md-0">
					<div class="avatar md2">
						<div class="inner rounded-md border-0"><img src="assets/img/users/1.jpg"></div>
					</div>
					<div class="col pl-4">
						<div class="d-flex align-items-center"><h5 class="my-0 font-light text-white font-sm-14">John Doe</h5> <span class="mx-3 font-xlight mt-1">-</span><small class="font-12 font-xlight">30 Minutes</small></div>
						...
						<div class="action d-flex align-items-center">
							...
							<div class="mr-4 pr-2 d-flex align-items-center">
								<label class="icon-default sm my-0 mr-2">
									...
									<em></em>
									<img src="assets/img/icons/dislike.svg">
								</label> Dislike
							</div>
						</div>
					</div>
				...
				<div class="row mt-5 ml-md-0 px-3 px-md-0">
					<div class="avatar md2">
						<div class="inner rounded-md border-0"><img src="assets/img/users/2.jpg"></div>
					</div>
					<div class="col pl-4">
				...
				<div class="row mt-5 ml-md-0 px-3 px-md-0">
					<div class="avatar md2">
						<div class="inner rounded-md border-0"><img src="assets/img/users/3.jpg"></div>
					</div>
					<div class="col pl-4">
				...
				<div class="row mt-5 ml-md-0 px-3 px-md-0">
					<div class="avatar md2">
						<div class="inner rounded-md border-0"><img src="assets/img/users/4.jpg"></div>
					</div>
					<div class="col pl-4">
