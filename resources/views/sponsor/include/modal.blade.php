            ...
            <div class="d-flex flex-column">
              ...
              <div class="modal-body d-flex flex-fill align-items-center">
                <div class="list-group font-medium col-sm-8 mx-auto pb-4 px-4 px-md-0 my-5 pt-2">
                  <a role="button" data-step="fnm-login" data-target="#login" data-id="6" class="open-login list-group-item list-primary arrow my-1 my-md-3 px-4 py-3">
                  ...
                  <a role="button" data-step="spr-login" data-target="#login"
                  data-id="5" class="list-group-item list-danger arrow my-1 my-md-3 px-4 py-3">
            ...
            <div class="d-flex flex-column h-100">
              <div class="heading text-dark text-center mx-auto col-sm-9 px-md-5 mb-2 mb-md-4 pb-2">
                ...
                <div class="social-login d-flex align-items-center justify-content-center">
                  <a href="{{ url('auth/facebook') }}" class="btn btn-facebook rounded-pill mx-3"><i class="icon fa fa-facebook"></i> Log In With Facebook</a>
                  <a href="{{ url('auth/google') }}" class="btn btn-google rounded-pill mx-3"><i class="icon fa fa-google-plus"></i> Log In With Google +</a>
                </div>
              </div>
              <div class="modal-body col-sm-8 mx-auto pt-0 pb-4 mb-2">
                <div class="ba-line text-dark text-center font-12 my-4 py-2"><span class="mx-3">Or Login Using Email</span></div>
              ...
              <div class="text-dark text-center mt-4 pt-1">
                <div class="mb-4">Don't have an account? 
                  <a role="button" data-step="fnm-step-4" data-target="#login" class="open-register text-primary" data-id="" id="user_type">Registration</a></div>
            ...
            <div class="d-flex flex-column">
              ...
              <div class="modal-body col-sm-8 mx-auto">
                <form method="POST" action="{{ route('registration') }}">
                  ...
                  <input type="hidden" name="user_type" value="4" id="user_value">
...
<!--           <div class="fnm-step-5 overflow-auto slim-scroll my-0 mr-2 mt-3 mb-3 d-none">
          ...
          <div class="step- spr-login overflow-auto slim-scroll my-0 mr-2 mt-3 mb-3 d-none h-100">
            <div class="d-flex flex-column h-100">
              <div class="heading text-dark text-center mx-auto w-75 px-5 mb-4">
                <h3 class="font-bold text-center mt-4 mb-0">Log In</h3>
              </div>
              <div class="modal-body col-sm-8 mx-auto pb-4 mb-2">
                <form id="sponsor-login-form">
                  <div class="form-group">
                    <input class="form-control rounded-pill p-4 font-14" placeholder="Enter Your Email*" name="sponsor_login_email">
                  </div>
                  <div class="form-group mb-4 pb-2">
                    <input type="password" class="form-control rounded-pill p-4 font-14" placeholder="Enter Your Password*" name="sponsor_login_password">
                  </div>
                  <button type="button" class="btn btn-primary btn-block py-1 rounded-pill sponsor-login-submit"><span class="my-2 d-block">Login</span></button>
                  <div class="mt-4 text-center">
                    <a role="button" data-step="reset-step" data-target="#login" class="font-14">Forgot Password?</a>
                  </div>
                </form>
          ...
          <div class="step- spr-signup overflow-auto slim-scroll my-0 mr-2 mt-3 mb-3 d-none">
            <div class="d-flex flex-column">
              <div class="heading text-dark text-center mx-auto w-75 px-5 mb-4 pb-2">
                <h3 class="font-bold text-center mt-4 mb-4">Sign Up</h3>
              </div>
              <div class="modal-body col-sm-8 mx-auto">
                <form id="sign-up-sponsor" enctype="multipart/form-data">
                  <div class="form-group">
                    <input type="text" class="form-control rounded-pill p-4 font-14" placeholder="Enter Your Email*" name="email" id="email-sponsor">
                  </div>
                  <div class="form-group mobile position-relative d-flex align-items-center flex-column">
                    <div class="country border-right">
                      <select class="d-inline border-0" name="code" id="code">
                    ...
                    <input class="form-control rounded-pill p-4 font-14" placeholder="Enter Your Mobile Number*" name="phone_no" id="phone_no">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control rounded-pill p-4 font-14" placeholder="Enter Your Password*" name="password" id="password_sponsor">
                  </div>
                  <div class="form-group">
                    <input type="password" class="form-control rounded-pill p-4 font-14" placeholder="Re-Enter Your Password*" name="confirm_password" id="confirm_password">
                  </div>
                  <button type="button" class="btn btn-primary btn-block py-1 rounded-pill mt-5 submit-details"><span class="my-2 d-block">Create Account</span></button>
                  <div class="text-dark text-center mt-5 pt-5">
                    <div class="mb-4">I have an account. <a role="button" data-step="spr-login" data-target="#login" class="text-primary">Log In Now</a></div>
                    <p class="font-12 text-muted">By logging in, you agree to our <a href="" class="text-underline-light text-muted">Privacy Policy</a> and <a href="" class="text-underline-light text-muted">Terms of Service</a></p>
                  </div>
                </form>
              </div>
          ...
          <div class="spr-cp overflow-auto slim-scroll my-0 mr-2 mt-3 mb-3 d-none complete_profile">
            <div class="d-flex flex-column">
              ...
              <div class="modal-body col-sm-8 mx-auto">
                <form id="complete_sponsor_profile" enctype="multipart/form-data">
                  <input type="hidden" name="_token" id="token" value="{{ csrf_token() }}">
                  <div class="form-group">
                    <input class="form-control rounded-pill p-4 font-14" placeholder="Business Name*" name="business_name" id="business_name">
                    <input type="hidden" name="sponsor_id" id="sponsor_id">
                    <input type="hidden" name="sponsor_email" id="sponsor_email">
                  </div>
                  <div class="form-group">
                    <input class="form-control rounded-pill p-4 font-14" placeholder="Business Owner Name*" name="business_owner_name" id="business_owner_name">
                  </div>
                  <div class="form-group">
                    <input class="form-control rounded-pill p-4 font-14" placeholder="Email Address*" name="business_email" id="business_email">
                  </div>
                  <div class="form-group">
                    <div class="form-control rounded-pill p-4 font-14 lg d-flex align-items-center uploadFile business_logo">
                      Business Logo* (<small id="stat_business_logo">Browse From Device Or Drag & Drop</small>)
                      <input type="file" name="sponsor_business_logo" id="sponsor_business_logo">
                    </div>
                  </div>
                  <div class="form-group mobile position-relative d-flex align-items-center">
                    <select class="form-control rounded-pill px-4 py-0 lg font-14 text-dark" name="business_type" id="business_type">
                  ...
                  <div class="form-group">
                    <div class="form-control rounded-pill p-4 font-14 lg d-flex align-items-center uploadFile id_proof">
                      Upload ID Proofs* (<small id="stat_id_proof">Browse From Device Or Drag & Drop</small>)
                      <input type="file" name="upload_id_proof" id="upload_id_proof">
                    </div>
                  </div>
                  <div class="form-check">
                    <input class="form-check-input" type="checkbox" value="" id="accept" name="checkboxes">
                    <label class="form-check-label text-muted font-14" for="accept" role="button">
                      I accept all <a href="{{route('privacy-policy')}}">Privacy Policy</a> and <a href="{{route('terms-n-conditions')}}">Terms & Conditions</a>
                    </label>
                  </div>
                  <button type="button" class="btn btn-primary btn-block py-1 rounded-pill mt-5 sponsor_details"><span class="my-2 d-block">Submit</span></button>
                </form>
              </div>
            </div>
          </div>
