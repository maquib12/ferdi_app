					...
					<div class="row">
						...
						<div class="d-flex flex-column px-md-3">
							<div class="bg-dark p-4 rounded-md text-center flex-fill">
								...
								<div class="font-36 font-bold text-underline my-4">CREDIT ₦ {{$bank_details[0]['users']['wallets'] ?? '0'}}</div>
								<div class="mb-4 text-xlight">December 25, 2021 . 05:30 PM</div>
						...
						<div class="row">
							...
							<div class="col-sm-12">
								<div class="border-top border-light3 text-center py-3 mt-4 pt-4">
									<button type="button" class="btn btn-primary btn-lg py-2 rounded-pill mt-4 col-sm-4 font-22 font-semibold saveCards"><span class="d-block my-2">SAVE CARD</span></button>
								</div>
							</div>
						</div>
					</div>
